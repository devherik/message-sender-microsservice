...
class TestMessageServiceBusinessLogic:
    ...
    async def test_create_message_success(self, message_service, mock_repository):
        ...
        # Arrange
        app_id = 123
        request = MessageRequest(message_content="Hello, World!", phone_number_id=456)
    ...
    async def test_create_message_rejects_empty_content(
        self, message_service, mock_repository
    ):
        """
    ...
    # ============================================================
    @pytest.mark.asyncio
    async def test_create_message_rejects_oversized_content(
        self, message_service, mock_repository
    ):
        """
        ...
        request = MessageRequest(message_content=oversized_content, phone_number_id=456)
    ...
    # ============================================================
    @pytest.mark.asyncio
    async def test_create_message_handles_repository_failure(
        self, message_service, mock_repository
    ):
        """
        ...
        # Arrange
        app_id = 123
        request = MessageRequest(message_content="Test message", phone_number_id=456)

        # Mock repository to raise an exception
        mock_repository.create_message.side_effect = Exception(
    ...
    # ============================================================
    @pytest.mark.asyncio
    async def test_create_message_propagates_correlation_id(
        self, message_service, mock_repository
    ):
        """
        ...
        request = MessageRequest(message_content="Test", phone_number_id=456)

        mock_repository.create_message.return_value = 789

        # Act
        result = await message_service.create_message(
            app_id, request, correlation_id=correlation_id
        )
...
class TestMessageRequestValidation:
    ...
    def test_message_request_accepts_valid_data(self):
        ...
        request = MessageRequest(message_content="Valid message", phone_number_id=123)
    ...
    def test_message_request_rejects_invalid_phone_id_type(self):
        ...
        with pytest.raises(ValueError):
            MessageRequest(message_content="Test", phone_number_id="not-an-integer")
